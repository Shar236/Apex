...
import { PearsonPTELogo, IELTSLogo, ETSToeflLogo, DuolingoTestLogo, ETSGreLogo } from '@/components/official-brand-logos';
...
/*
 * Pills always use a WHITE background in BOTH light and dark modes so dark-colored
 * logos (Pearson navy, TOEFL near-black, GRE purple) stay readable regardless of theme.
 */
const pillClass = [
...
function LogoGroup({ prefix }: { prefix: string }) {
  return (
...
export function ExamLogoMarquee() {
  return (
    <section aria-label="Exam platforms supported by Apex Vouchers" className="py-6 sm:py-8 bg-surface border-y border-line relative overflow-hidden transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-3 text-center">
        <span className="text-[11px] font-medium uppercase tracking-widest text-ink-muted">Vouchers Available For Leading English-Language Exams</span>
      </div>
