import{b as l,j as e}from"./react-vendor-COHWftRJ.js";import{u as d,a as r}from"./index-C_9kzR0a.js";import{G as c,n as p,t as x,A as m,u as b,v as g,H as u}from"./icons-Cbj404Jl.js";import"./vendor-DyM_VQcP.js";const h=[{examType:"PTE Academic",slug:"pte-academic",badge:"MOST BOOKED",icon:c,tint:"#005A9C",desc:"For study visas & university admissions worldwide. We help you find the right test centre and date.",illustration:"/pte-academic-illustration.jpg",illustrationAlt:"Student studying at desk with books, laptop and coffee cup",accentFrom:"#EEF6FF",accentTo:"#FFFFFF",accentFromDark:"#081525",accentToDark:"#161616",borderLight:"#005A9C28",borderDark:"#005A9C55",btnGrad:"linear-gradient(135deg,#0074cc,#005A9C)",btnHoverGrad:"linear-gradient(135deg,#0080e0,#0065b0)"},{examType:"PTE Core",slug:"pte-core",badge:"CANADA PR",icon:p,tint:"#FF005C",desc:"IRCC-approved test for Canada Express Entry & PR pathways. Get assistance booking your preferred slot.",illustration:"/pte-core-illustration.jpg",illustrationAlt:"Relaxed student sitting in armchair using laptop with plant nearby",accentFrom:"#FFF0F5",accentTo:"#FFFFFF",accentFromDark:"#280912",accentToDark:"#161616",borderLight:"#FF005C28",borderDark:"#FF005C55",btnGrad:"linear-gradient(135deg,#ff1a6e,#FF005C)",btnHoverGrad:"linear-gradient(135deg,#ff2d7e,#e00052)"},{examType:"PTE Academic UKVI",slug:"pte-ukvi",badge:"UK VISA (SELT)",icon:x,tint:"#6C3CE0",desc:"For UK visa & immigration applications. Our team helps coordinate your official booking request.",illustration:"/pte-ukvi-illustration.jpg",illustrationAlt:"Student at laptop with email, stars and confirmation document floating around",accentFrom:"#F4F0FF",accentTo:"#FFFFFF",accentFromDark:"#130A28",accentToDark:"#161616",borderLight:"#6C3CE028",borderDark:"#6C3CE055",btnGrad:"linear-gradient(135deg,#7c4df0,#6C3CE0)",btnHoverGrad:"linear-gradient(135deg,#8b5df5,#7a47f0)"}],f=[{icon:b,text:"We help you find available dates & centres"},{icon:g,text:"Real support team, not an automated booking bot"},{icon:u,text:"Follow-up by email, WhatsApp & phone"}],j=()=>{const{setActiveTab:s}=d(),i=l(),o=t=>{s("exam-booking"),i(`/exam-booking?exam=${t}`)};return e.jsxs("section",{id:"pte-booking-assistance",className:"py-16 sm:py-24 bg-[#FAFAFA] dark:bg-[#0D0D0D] border-b border-slate-200/80 dark:border-[#292929] transition-colors duration-300",children:[e.jsx("style",{children:`
        .pte-card {
          border-radius: 22px;
          border-width: 1.5px;
          border-style: solid;
