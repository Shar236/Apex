...
import { Lightbulb, TriangleAlert, CheckCircle2, Globe, ShieldCheck, Sparkles, HelpCircle } from 'lucide-react';
import {
  ArticleFigure,
  ArticleInfoBox,
  ScoreCards,
...
import { articleImage } from '../lib/articleImage.js';
import '../styles/article-shared.css';
import '../styles/articles/pte-tests-comparison.css';

/**
 * Code-based article for the blog slug:
 *   pte-tests-comparison-2026
 *
 * All CMS-managed metadata (title, category, excerpt, author, SEO title,
 * meta description, canonical, OG tags, FAQs, related posts) flow through
 * props from the public blog API, while this component renders the rich custom
 * article body and interactive comparisons.
 */
...
const DEFAULT_FAQS = [
  ...
  },
  {
    ...
    answer:
      'Pearson PTE score reports are officially valid for 2 years from the date of the exam for universities and most immigration departments (note: Australian skilled migration allows PTE Academic scores up to 3 years old at time of invitation).',
  },
  {
    question: 'Can I save money on my PTE exam booking in India?',
    answer:
      'Yes! By purchasing an official PTE voucher code from Apex Vouchers before booking on Pearson\'s website, you can save up to ₹3,900 on your test fee with guaranteed instant code delivery.',
  },
];

export default function PteTestsComparison({ post = {}, relatedPosts = [] }) {
  const title =
    post.title || 'PTE Tests Comparison 2026: PTE Academic vs PTE Core vs PTE UKVI vs PTE Home';
  ...
  return (
    <article className="blog-article blog-pte-tests-comparison">
      ...
      <div className="pte-hero">
        <ArticleFigure
          src={articleImage(post, 'hero', `${IMG}/hero.webp`)}
          alt="Comparison chart of PTE Academic, PTE Core, PTE Academic UKVI and PTE Home test formats and acceptance"
          width={1200}
          height={630}
          priority
        />
      ...
      <div className="ca-body">
        ...
        {/* Section 1: The 4 Test Types */}
        <h2 id="four-pte-types">Understanding the 4 Pearson PTE Test Types</h2>
        <p>
          Pearson Test of English (PTE) is a computer-delivered, 100% AI-scored English proficiency assessment.
          While all four variants share Pearson&rsquo;s automated scoring engine and state-of-the-art testing centre
          security, they serve completely different visa and academic requirements:
        </p>
        ...
        <div className="pte-grid">
          <div className="pte-test-card">
            ...
            <h3>PTE Academic</h3>
            <p>
              The flagship academic English exam. Evaluates higher-education English proficiency using university lectures,
              academic essays, and academic reading excerpts.
            </p>
          ...
          <div className="pte-test-card">
            ...
            <h3>PTE Core</h3>
            <p>
              Pearson&rsquo;s newest test, approved by IRCC in 2024 for Canadian economic migration. Tests everyday,
              workplace-oriented English scenarios rather than university academia.
            </p>
            <div className="pte-card-meta">
          ...
          <div className="pte-test-card">
            ...
            <p>
              The Secure English Language Test (SELT) version of PTE Academic approved by the UK Home Office.
              Generates a Unique Electronic Reference Number (UERN) required on UK visa forms.
            </p>
            <div className="pte-card-meta">
          ...
          <div className="pte-test-card">
            ...
            <p>
              Short, conversational tests assessing only Speaking and Listening for UK family reunion, spouse visas,
        ...
        {/* Section 2: Academic vs Core */}
        <h2 id="academic-vs-core">PTE Academic vs PTE Core: What Actually Changes?</h2>
        <p>
          Both PTE Academic and PTE Core take approximately <strong>2 hours</strong>, test all four language skills
          (Speaking, Writing, Reading, Listening), and are scored on the 10&ndash;90 Global Scale of English.
          However, the task types and prompt topics differ significantly:
        </p>
        ...
        <div className="pte-task-compare">
          <div className="pte-task-col">
            ...
            <ul>
              <li><strong>Write Essay:</strong> 200&ndash;300 word formal argumentative essay on abstract/societal topics.</li>
              <li><strong>Summarize Written Text:</strong> Condense academic passages into one single 5&ndash;75 word sentence.</li>
              <li><strong>Re-tell Lecture:</strong> Listen to university professor lectures and summarize key academic arguments.</li>
              <li><strong>Describe Image:</strong> Analyze complex charts, statistical graphs, scientific diagrams, and maps.</li>
            </ul>
          </div>
          <div className="pte-task-col">
            <h4>PTE Core Tasks</h4>
            <ul>
              <li><strong>Write Email:</strong> 100-word functional email to a colleague, landlord, or supervisor (9 min).</li>
              <li><strong>Summarize Written Text:</strong> Condense real-world texts in 25&ndash;50 words (multiple sentences allowed).</li>
              <li><strong>Respond to a Situation:</strong> Listen to everyday scenarios (e.g. asking for leave) and reply verbally.</li>
              <li><strong>Describe Image:</strong> Describe everyday infographics, process diagrams, or workplace illustrations.</li>
            </ul>
          </div>
        </div>
        ...
        <ArticleInfoBox variant="warning" title="Critical Note for Canada Applicants" icon={<TriangleAlert className="w-4 h-4" />}>
          <p>
            If you are preparing for <strong>Canada Express Entry, PNP, or Canadian Experience Class</strong>, you
            <strong> MUST take PTE Core</strong>, not PTE Academic. Submitting a PTE Academic score card for Express Entry
            will result in an immediate profile rejection.
          </p>
        </ArticleInfoBox>
        ...
        <p>
          Compare all key specifications across testing purpose, duration, scoring, visa eligibility, and recognition:
        </p>
        ...
        <ArticleFigure
          src={articleImage(post, 'pte-tests-comparison-chart', `${IMG}/pte-tests-comparison-chart.webp`)}
          alt="Visual comparison table infographic summarizing Pearson PTE test differences"
          width={1200}
          height={800}
          caption="Summary of Pearson PTE test variants and their official visa pathways."
        />

        {/* Section 4: UKVI Explained */}
        <h2 id="ukvi-explained">PTE Academic UKVI vs Standard PTE Academic: What Is the Difference?</h2>
        <p>
          One of the most frequent points of confusion for students and professionals headed to the United Kingdom is
          whether to book <strong>PTE Academic</strong> or <strong>PTE Academic UKVI</strong>.
        </p>
        <p>
          Both exams test the <em>exact same 20 question types</em>, use identical questions from the same item bank,
          and share the same scoring algorithms. However, there are two legal differences:
        </p>
        <ul>
          <li>
            <strong>SELT Accreditation:</strong> PTE Academic UKVI is administered under strict UK Home Office guidelines
            at designated Secure English Language Testing (SELT) centres.
          </li>
          <li>
            <strong>Unique Electronic Reference Number (UERN):</strong> When you receive your PTE UKVI scorecard,
            it includes a UERN code. You must enter this code in your UK visa application form so UKVI can directly
            verify your score in the Home Office database.
          </li>
        </ul>

        <ArticleInfoBox variant="note" title="When can you use Standard PTE Academic for the UK?" icon={<ShieldCheck className="w-4 h-4" />}>
          <p>
            If you are studying at a <strong>Higher Education Institution (HEI)</strong> for a Bachelor&rsquo;s, Master&rsquo;s,
            or PhD programme, most UK universities are permitted to make their own language assessment and will accept standard
            PTE Academic. However, if your course is below degree level (foundation, pre-sessional, diploma) or you are applying
            for a <strong>Skilled Worker Visa</strong>, PTE Academic UKVI is legally required.
          </p>
        </ArticleInfoBox>
        ...
        <p>
          Unlike the 4-skill academic and general exams, <strong>PTE Home</strong> is a family of simplified speaking and
          listening tests designed specifically for UK family migration and settlement:
        </p>
        <ul>
          <li>
        ...
        <p>
          PTE Home tests are reported as a simple <strong>Pass or Fail</strong> based on whether you meet the Common European
          Framework of Reference (CEFR) standard for that level.
        </p>

        {/* Section 6: Score Equivalency & CLB Mapping */}
        <h2 id="score-equivalency">Score Equivalency: PTE vs IELTS, CLB & CEFR</h2>
        <p>
          To understand where your score sits across international standards, use the official score concordances
          established by Pearson, IRCC, and the UK Home Office:
        </p>
        ...
        <ArticleFigure
          src={articleImage(post, 'pte-decision-flowchart', `${IMG}/pte-decision-flowchart.webp`)}
          alt="Flowchart guiding candidates on which PTE exam to select based on destination country and visa purpose"
          width={1200}
          height={800}
          caption="Decision flowchart: Pick the right test based on country, visa, and institution rules."
        />

        {/* Section 7: Decision Guide */}
        <h2 id="decision-guide">Which PTE Test Should You Book? (Decision Guide)</h2>
        <p>
          Follow this direct decision matrix to confirm the exact test you should register for:
        </p>
        ...
        {/* Section 8: Voucher Savings */}
        <h2 id="voucher-savings">How to Save on Your PTE Test Booking</h2>
        <p>
          The standard test fee for PTE Academic and PTE Core in India is <strong>₹17,000+ (inclusive of 18% GST)</strong>.
          However, you do not need to pay full price at checkout on the Pearson website.
        </p>

        <ArticleInfoBox variant="tip" title="Apex Saver Tip: Save Up to ₹3,900 Instantly" icon={<Sparkles className="w-4 h-4" />}>
          <p>
            You can purchase an official <strong>PTE Academic Voucher</strong> or <strong>PTE Core Voucher</strong> through
            Apex Vouchers at exclusive student pricing. You will receive a genuine 100% official alphanumeric voucher code
            delivered instantly via email and WhatsApp. Enter the code at checkout on <em>mypte.pearsonpte.com</em> to reduce
            your test registration balance to ₹0.
          </p>
        </ArticleInfoBox>
        ...
        <div className="ca-cta" data-toc-ignore>
          ...
          <Link to="/exam-booking">Browse PTE Exam Vouchers →</Link>
        </div>
        ...
        <ArticleInfoBox variant="warning" title="Avoid these costly errors" icon={<TriangleAlert className="w-4 h-4" />}>
          <p>
            Booking the wrong exam can result in rejected university applications, lost PR invitation deadlines,
            and forfeiture of non-refundable test fees.
          </p>
        </ArticleInfoBox>

        <ol>
          <li>
            <strong>Booking PTE Academic for Canadian PR:</strong> IRCC rejects PTE Academic for economic immigration.
            Always select <em>PTE Core</em> for Express Entry.
          </li>
          <li>
            <strong>Booking standard PTE Academic for UK Skilled Worker Visas:</strong> The UK Home Office requires a SELT
            Unique Reference Number (UERN). Without booking the <em>PTE Academic UKVI</em> version, your visa application will be invalidated.
          </li>
          <li>
            <strong>Practicing with Academic Templates for PTE Core:</strong> PTE Core asks for emails (not long essays)
            and conversational situational responses (not academic lecture retells). Practice with Core-specific materials.
          </li>
          <li>
            <strong>Ignoring Sectional Sub-score Requirements:</strong> Many institutions require <em>no subscore below 58</em>
            or <em>CLB 9 in all 4 abilities</em>. High overall scores cannot compensate for a low reading or speaking subscore.
          </li>
          <li>
            <strong>Booking Test Dates Too Close to Intake Deadlines:</strong> While results often arrive within 48 hours,
            occasional audit reviews take up to 5 business days. Always take your test at least 3&ndash;4 weeks before your deadline.
          </li>
        </ol>
        ...
        <aside className="ca-takeaways" id="takeaways">
          <h2>Key Takeaways</h2>
          <ul>
            <li><strong>PTE Academic</strong> = Global study abroad (USA, UK, Canada, Australia) & Australia/NZ PR.</li>
            <li><strong>PTE Core</strong> = Canada PR (Express Entry / PNP) & work permits under IRCC.</li>
            <li><strong>PTE Academic UKVI</strong> = UK work visas & foundation study requiring a SELT UERN code.</li>
            <li><strong>PTE Home</strong> = UK family, spouse, ILR settlement, and citizenship (Speaking & Listening only).</li>
        ...
        <p>
          Related guides:{' '}
          <Link to="/blog?category=PTE">browse all PTE articles</Link>, read our{' '}
          <Link to="/blog/ielts-score-canada-8-7-7-7-rule-2026">IELTS Canada PR 8-7-7-7 guide</Link>, or check the{' '}
          <Link to="/blog">complete students diary</Link>.
        </p>
