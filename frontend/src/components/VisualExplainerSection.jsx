  ...
  const explainerCards = [
    {
      ...
      desc: 'An official alphanumeric <span class="text-accent">discount voucher code</span> sent to your email & WhatsApp.',
      icon: Ticket
    },
    {
      title: 'How to use it',
      desc: 'Simply paste the code into the <span class="text-ink">Voucher / Promo Code</span> box at checkout on the test portal.',
      icon: CheckCircle2
    },
    {
      title: 'Where to redeem it',
      desc: 'Directly on official test sites (<span class="text-ink">mypte.pearsonpte.com</span>, <span class="text-ink">ets.org</span>, or <span class="text-ink">duolingo.com</span>).',
      icon: ShieldCheck
    },
    {
      title: 'Validity & Conditions',
      desc: 'Valid for <span class="text-accent">6 to 12 months</span>. 100% money-back guarantee if unredeemed within 7 days.',
      icon: Info
    }
  ];
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-md bg-[#0B0D12] rounded-3xl p-6 sm:p-8 text-white shadow-2xl border border-white/10 space-y-6">
              ...
              <div className="flex items-center justify-between border-b border-white/10 pb-4">
                ...
                <span className="px-2.5 py-0.5 rounded-full bg-success/20 text-success text-[10px] font-medium">
                  OFFICIAL PASS
                </span>
              </div>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              {explainerCards.map((card, idx) => {
                ...
                return (
                  <div key={idx} className="p-4 rounded-2xl bg-surface-raised border border-line space-y-2">
                    ...
                    <p
                      className="text-xs text-ink-muted font-normal leading-relaxed"
