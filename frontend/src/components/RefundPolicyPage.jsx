      ...
      <div className="bg-[var(--color-surface)] border-b border-[var(--color-line)]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-4">
          <nav className="flex items-center gap-2 text-xs font-normal text-[var(--color-ink-muted)]">
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[var(--color-accent)] font-normal">Refund & Cancellation Policy</span>
          </nav>
        </div>
      </div>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12 space-y-10 text-sm sm:text-base text-[var(--color-ink-muted)] leading-relaxed">
        ...
        <section className="bg-[var(--color-surface)] p-6 sm:p-8 rounded-3xl border border-[var(--color-line)] shadow-sm space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-1">
            <div className="p-5 rounded-2xl bg-[var(--color-surface-raised)] border border-[var(--color-line)] space-y-2">
              <h3 className="font-heading font-medium text-sm text-[var(--color-ink)]">
            ...
            <div className="p-5 rounded-2xl bg-[var(--color-accent)]/[0.08] border border-[var(--color-accent)]/30 space-y-2">
              <h3 className="font-heading font-medium text-sm text-[var(--color-accent)]">
        ...
        <section className="bg-[var(--color-surface)] p-6 sm:p-8 rounded-3xl border border-[var(--color-line)] shadow-sm space-y-6">
          <h2 className="font-heading font-medium text-xl sm:text-2xl text-[var(--color-ink)] flex items-center gap-2.5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-4 rounded-2xl bg-[var(--color-surface-raised)] border border-[var(--color-line)] space-y-1">
              <span className="text-[11px] font-normal text-neutral-400 uppercase">Eligibility</span>
              <p className="text-xs sm:text-sm font-normal text-[var(--color-ink)]">
          ...
          <div className="p-4 rounded-2xl bg-[var(--color-surface-raised)] border border-[var(--color-line)] text-xs space-y-2">
            <div className="font-normal text-[var(--color-ink)]">Code Invalidation on Refund:</div>
        ...
        <section className="bg-[var(--color-surface)] p-6 sm:p-8 rounded-3xl border border-[var(--color-line)] shadow-sm space-y-5">
          <h2 className="font-heading font-medium text-xl sm:text-2xl text-[var(--color-ink)] flex items-center gap-2.5">
          ...
          <div className="space-y-3 text-xs sm:text-sm">
            <div className="p-4 rounded-2xl bg-[var(--color-surface-raised)] border border-[var(--color-line)] flex items-start gap-3">
              <div className="w-7 h-7 rounded-lg bg-[var(--color-accent)] text-white font-normal flex items-center justify-center shrink-0">1</div>
              <div>
            ...
            <div className="p-4 rounded-2xl bg-[var(--color-surface-raised)] border border-[var(--color-line)] flex items-start gap-3">
              <div className="w-7 h-7 rounded-lg bg-[var(--color-accent)] text-white font-normal flex items-center justify-center shrink-0">2</div>
              <div>
                <strong>Option B — Via WhatsApp / Email:</strong> Contact support at <a href={`mailto:${supportEmail}`} className="text-[var(--color-accent)] font-normal">{supportEmail}</a> or WhatsApp <a href={`https://wa.me/${supportPhone.replace(/\D/g, '')}`} className="text-[var(--color-accent)] font-normal">{supportPhone}</a> with your Order ID.
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="p-8 rounded-3xl bg-[#0B0D12] text-white border border-white/5 space-y-4">
          ...
          <div className="flex flex-wrap gap-4 pt-2 text-xs">
            ...
            >
              <Mail className="w-4 h-4 text-[var(--color-accent)]" /> {supportEmail}
            </a>
            <a
              href={`https://wa.me/${supportPhone.replace(/\D/g, '')}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-[var(--color-accent)] hover:bg-[var(--color-accent-hover)] text-white font-normal shadow-md transition"
            >
