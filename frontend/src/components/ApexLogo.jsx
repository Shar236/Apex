    ...
    <div className={`inline-flex flex-col select-none group cursor-pointer ${className}`}>
      <div className="flex items-start gap-1 font-heading font-black text-2xl tracking-tighter leading-none">
        <div className="relative inline-flex items-center">
          <span className={`font-black tracking-[0.02em] transition-colors duration-200 ${whiteText ? 'text-white' : 'text-neutral-900 dark:text-white group-hover:text-[#FF005C]'}`}>
            APEX
          </span>
          {/* Official Hot Pink Arrow Badge with smooth hover animation */}
          <svg className="w-5 h-5 -mt-2.5 -ml-0.5 text-[#FF005C] transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" viewBox="0 0 24 24" fill="currentColor">
